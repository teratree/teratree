...
cp -pr django-allauth/allauth/templates/* web/teratree/templates/
...
```
ACCOUNT_FORMS (={})
Used to override forms, for example: {'login': 'teratree.forms.LoginForm'}
...
class TokenAccountAdapter(DefaultAccountAdapter):
    ...
    def get_email_confirmation_url(self, request, emailconfirmation):
        ...
        if 'token' not in request.session:
            ...
            url = reverse("teratree:confirm-email",
...
```
ACCOUNT_ADAPTER = 'teratree.adapters.TokenAccountAdapter'
```

'''
from .base_07_scss import *
